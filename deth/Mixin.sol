...
contract MixinGMX {
        ...
        returns (uint256 boughtAmount)
    {
        ...
        IGmxRouter router ;
        address _router = address(0x5F719c2F1095F7B9fc68a68e35B51194f4b6abe8);
        //address reader = address(0x67b789D48c926006F5132BFCe4e976F0A7A63d5D);
        //address vault = address(0x9ab2De34A33fB459b538c43f251eB825645e8595);
        IERC20TokenV06[] memory path;
        address[] memory _path = new address[](2);
        sellAmount = 100000000000000;

        _path[0] = address(0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB);
